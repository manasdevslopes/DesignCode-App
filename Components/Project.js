            ...
            <TouchableWithoutFeedback onPress={this.openCard}>
                <AnimatedContainer style={{ width: this.state.cardWidth, height: this.state.cardHeight }}>
                    <Cover>
                        ...
                        <AnimatedTitle style={{ paddingTop: this.state.titleTop }}>{this.props.title}</AnimatedTitle>
                    ...
                    />
                    <TouchableOpacity onPress={this.closeCard} style={{ position: "absolute", top: 20, right: 20 }}>
