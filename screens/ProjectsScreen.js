...
import { Button, PanResponder, Animated } from 'react-native';
...
class ProjectsScreen extends Component {
    ...
    render() {
        return (
            <Container>
                <MaskAnimated style={{ opacity: this.state.opacity }} />
                <Animated.View style={{
                    transform: [
                ...
                <Animated.View style={{ position: 'absolute', top: 0, left: 0, zIndex: -1, width: '100%', height: '100%', justifyContent: 'center', alignItems: 'center', transform: [{ scale: this.state.scale }, { translateY: this.state.translateY }] }}>
                    <Project
                ...
                <Animated.View style={{ position: "absolute", top: 0, left: 0, zIndex: -3, width: "100%", height: "100%", justifyContent: "center", alignItems: "center", transform: [{ scale: this.state.thirdScale }, { translateY: this.state.thirdTranslateY }] }}>
                    <Project
